...
# ============================================================================
# Phase 2: Maid Voice Handoffs
# ============================================================================
# 
# Maid delegation is now handled via native LiveKit agent handoffs.
# See maids/handoff_tools.py for the proper implementation.
#
# The summon_* tools return Agent instances, which triggers LiveKit to:
# 1. Switch to the maid's voice (configured in their llm= RealtimeModel)
# 2. Call the maid's on_enter() for introduction
# 3. Give the maid full control until they return_to_aria
#
# Old delegation tools (delegate_to_maid, call_maid, etc.) have been removed
# as they bypassed the voice handoff system.
